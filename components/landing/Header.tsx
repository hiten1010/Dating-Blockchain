...
export function Header({ activeSection, scrollY, navItems, mobileMenuOpen, setMobileMenuOpen }: HeaderProps) {
  // Use the props for mobile menu state instead of local state
