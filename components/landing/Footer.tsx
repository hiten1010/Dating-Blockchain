        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">How it Works</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Features</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Security</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Pricing</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Blog</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Documentation</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Partners</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Support</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="font-semibold text-[#1F2937] mb-3">Company</h3>
            <ul className="space-y-2">
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">About Us</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Careers</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Privacy Policy</Link></li>
              <li><Link href="#" className="text-sm text-[#6B7280] hover:text-[#EC4899]">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
        
        <div className="mt-12 pt-8 border-t border-[#E5E7EB] text-center text-sm text-[#6B7280]">
          <p>© {new Date().getFullYear()} DecentralMatch. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
